...
const regions = [
  { label: "🇮🇳 India", regionCode: "IN", color: "#FF9933" },
  {
    label: "🎵 Punjabi",
    regionCode: "IN",
    query: "Punjabi trending songs 2026",
    color: "#FF4FD8",
  },
  {
    label: "🎙️ Punjabi Hits",
    regionCode: "IN",
    query: "New Punjabi songs 2026 latest hits",
    color: "#FF6B35",
  },
  {
    label: "🎬 Bollywood",
    regionCode: "IN",
    query: "Bollywood trending 2026",
    color: "#23E6E2",
  },
  { label: "🌍 Global", regionCode: "US", color: "#8A5CFF" },
  {
    label: "🔥 Phonk",
    regionCode: "US",
    query: "trending phonk music 2026",
    color: "#FF2D55",
  },
  {
    label: "💀 Dark Phonk",
    regionCode: "US",
    query: "dark phonk drift music 2026",
    color: "#9B1FFF",
  },
  {
    label: "🎤 Hip-Hop",
    regionCode: "US",
    query: "hip hop trending 2026",
    color: "#FFB347",
  },
];
