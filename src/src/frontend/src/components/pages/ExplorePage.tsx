      ...
      <div>
        ...
        {isLoading ? (
          ...
          <div data-ocid="explore.error_state" className="text-center py-12">
            <p className="font-semibold mb-1" style={{ color: "#FF4FD8" }}>
              Search Error
            </p>
            <p className="text-sm" style={{ color: "#9AA6B2" }}>
              {String(error).includes("quota")
                ? "YouTube API quota khatam ho gayi. Kal dobara try karo."
                : "Search fail hui. Internet check karo aur dobara try karo."}
            </p>
          </div>
